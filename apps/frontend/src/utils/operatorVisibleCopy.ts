...
export function collectOperatorVisibleCopy(): OperatorVisibleCopyEntry[] {
  const entries: OperatorVisibleCopyEntry[] = [
    ...
    {
      id: 'profiles.authoring-retired',
      text: PROFILES_AUTHORING_RETIRED_NOTE,
    },
    {
      id: 'profiles.trust-catalogs-hint',
      text: PROFILES_TRUST_CATALOGS_HINT,
    },
    ...
    {
      id: 'profiles.overview-compare-heading',
      text: PROFILES_OVERVIEW_COMPARE_HEADING,
    },
    {
      id: 'profiles.overview-enablement-heading',
      text: PROFILES_OVERVIEW_ENABLEMENT_HEADING,
    },
    { id: 'profiles.overview-yaml-heading', text: PROFILES_OVERVIEW_YAML_HEADING },
    ...
    {
      id: 'profiles.token-catalog-heading',
      text: PROFILES_CONV_TEMPLATES_CATALOG_HEADING,
    },
    { id: 'profiles.token-catalog-help', text: PROFILES_CONV_TEMPLATES_CATALOG_HELP },
    { id: 'profiles.token-catalog-empty', text: PROFILES_CONV_TEMPLATES_CATALOG_EMPTY },
    {
      id: 'profiles.token-catalog-loading',
      text: PROFILES_CONV_TEMPLATES_CATALOG_LOADING,
    },
    { id: 'profiles.token-search', text: PROFILES_CONV_TEMPLATES_SEARCH },
    {
      id: 'profiles.token-search-placeholder',
      text: PROFILES_CONV_TEMPLATES_SEARCH_PLACEHOLDER,
    },
    { id: 'profiles.token-slot-label', text: PROFILES_CONV_TEMPLATES_SLOT_LABEL },
    { id: 'profiles.token-save', text: PROFILES_CONV_TEMPLATES_SAVE },
    { id: 'profiles.token-saved', text: PROFILES_CONV_TEMPLATES_SAVED },
    { id: 'profiles.token-readonly', text: PROFILES_CONV_TEMPLATES_READONLY },
    { id: 'profiles.tac-rules-heading', text: PROFILES_TAC_RULES_HEADING },
    { id: 'profiles.tac-rules-help', text: PROFILES_TAC_RULES_HELP },
    { id: 'profiles.tac-rules-readonly', text: PROFILES_TAC_RULES_READONLY },
    { id: 'profiles.tac-rules-save', text: PROFILES_TAC_RULES_SAVE },
    { id: 'profiles.iwxxm-rules-heading', text: PROFILES_IWXXM_RULES_HEADING },
    { id: 'profiles.iwxxm-rules-help', text: PROFILES_IWXXM_RULES_HELP },
    { id: 'profiles.iwxxm-rules-readonly', text: PROFILES_IWXXM_RULES_READONLY },
    { id: 'profiles.iwxxm-rules-save', text: PROFILES_IWXXM_RULES_SAVE },
