...
| SIGMET   | 5 (A6-1a-TS + A6-1b-CNL + VA-EGGX ref + A6-2-TC ref + multi-location-VA passer) | **#829** / EV-030 T2.4: `sigmet-A6-2-TC` unlocked as `wmoReference` (lint→convert→validate green; ADR-032 equality pending — coord/FIR/intensity deltas); **#809** multi-location-VA `wmoPass` |
