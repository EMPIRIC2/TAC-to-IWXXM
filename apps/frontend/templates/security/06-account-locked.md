    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="alert-box">
          ...
          <p>
            This happened after multiple failed login attempts. The lock is temporary
            and will automatically expire in {{ .Data.minutesRemaining }} minutes.
          </p>
        </div>

        <div class="timer">🔒 Locked | Expires: {{ .Data.unlockTime }} UTC</div>
