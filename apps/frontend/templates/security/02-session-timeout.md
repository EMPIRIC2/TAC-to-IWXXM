    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="warning-box">
          ...
          <p>
            We haven't detected any activity on your account recently. If you're still
            working, click the button below to extend your session.
          </p>
        </div>

        <div class="timer">⏱️ Time Remaining: {{ .Data.minutesRemaining }} minutes</div>
        ...
        <p>
          For security reasons, sessions automatically expire after a period of
          inactivity. This helps protect your account from unauthorized access if you
