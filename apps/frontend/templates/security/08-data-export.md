    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="success-box">
          <p>
            <strong
              >✓ Your data export has been prepared and is ready for download!</strong
            >
          </p>
          <p>
            All your personal information has been compiled into a single file for your
            records.
          </p>
        </div>
        ...
        <a
          href="{{ .SiteURL }}/account/data-export/{{ .Data.exportId }}/download"
          class="button"
        >
        ...
        <p style="margin-top: 15px; font-size: 14px; color: #666;">
          ...
          <code
            style="background: #f0f0f0; padding: 5px; border-radius: 3px; 
        ...
        <p style="margin-top: 20px; font-size: 14px; color: #666;">
          ...
          <a href="{{ .SiteURL }}/docs/data-export" style="color: #667eea;"
            >data export guide</a
          >
          for instructions.
        </p>
