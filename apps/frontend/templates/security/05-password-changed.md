    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="success-box">
          ...
          <p>
            Your account is now more secure. All other sessions have been automatically
            logged out as a security measure.
          </p>
        </div>
        ...
        <ol>
          <li>
            <a href="{{ .SiteURL }}/account/password-reset"
              >Reset your password again</a
            >
          </li>
          <li>
            <a href="{{ .SiteURL }}/account/security">Review your account security</a>
          </li>
        ...
        <p style="margin-top: 20px; font-size: 14px; color: #666;">
          <strong>Need to log in again?</strong> Just use your email and your new
          password.
        </p>
      </div>
      <div class="footer">
