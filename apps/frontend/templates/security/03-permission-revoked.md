    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="alert-box">
          <p>
            <strong
              >Your account permissions have been changed by an administrator.</strong
            >
          </p>
          <p>
            This change is effective immediately and may affect your access to certain
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
              ...
              <td style="padding: 8px;">
                <strong style="color: #ff6b6b;">{{ .Data.newRole }}</strong>
              </td>
            </tr>
          </table>
        </div>
        ...
        <p
          style="background: #e3f2fd; padding: 12px; border-radius: 4px; margin-top: 15px;"
        >
          <strong>Need Help?</strong> Contact your account administrator: {{
          .Data.adminEmail }}
        </p>
      </div>
      <div class="footer">
