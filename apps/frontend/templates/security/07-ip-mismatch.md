    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="alert-box">
          <p>
            <strong
              >We detected a login to your account from a significantly different
              geographic location than your last login.</strong
            >
          </p>
        ...
        <div class="details-box">
          <table style="width: 100%; border-collapse: collapse;">
            <tr style="border-bottom: 1px solid #ddd;">
              <td style="padding: 8px; font-weight: bold; width: 40%;">
                Last Location:
              </td>
        ...
        <div class="safe-note">
          <p>
            ...
            from a different network. You can safely ignore this email.
          </p>
        </div>

        <a
          href="{{ .SiteURL }}/account/security?action=mark-location-safe"
          class="button"
        >
        ...
        <ol>
          ...
          <li>
            <a href="{{ .SiteURL }}/account/password-reset">Change your password</a>
            immediately
          </li>
          <li>
            <a href="{{ .SiteURL }}/account/security">Review all active sessions</a>
          </li>
...
async function detectLocationAnomaly(
  ...
  const distance = calculateDistance(lastLogin.location, newLocation);
