  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>
          This is a confirmation that your account email address has been successfully
          changed.
        </p>
        ...
        <ol>
          ...
          <li>
            <a href="{{ .SiteURL }}/contact-support">Contact support</a> if compromised
          </li>
        </ol>

        <a href="{{ .SiteURL }}/account/settings" class="button"> Manage Account </a>
        ...
        <p
          style="background: #fff3cd; padding: 10px; border-radius: 4px; margin-top: 15px;"
        >
      ...
      <div class="footer">
        ...
        <p style="margin-top: 10px;">
          <a href="{{ .SiteURL }}/account/settings" style="color: #667eea;"
            >Account Settings</a
          >
          |
...
2. **Include IP address for security audit**:
   ...
   ```html
   <p style="font-size: 12px; color: #999;">Changed from IP: {{ .Data.ipAddress }}</p>
   ```
...
4. **Link to verify new email**:
   ```html
   <p>
     Didn't verify your new email yet?
     <a href="{{ .SiteURL }}/verify-email">Verify now</a>
   </p>
   ```
