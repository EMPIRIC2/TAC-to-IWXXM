  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="security">
          <strong>🔒 Security Note:</strong> This link expires in 15 minutes and can
          only be used once. If you didn't request this link, please delete this email.
        </div>

        <p>
          <strong>Why did you get this email?</strong><br />
          You (or someone) requested a magic link sign-in for {{ .Email }}. Magic links
          are a secure alternative to passwords.
        </p>
      </div>
      <div class="footer">
...
3. **Add FAQ section**:
   ...
   <p>
     Magic links provide a password-free way to sign in. When you click the link, we
     verify your identity and log you in securely.
   </p>
   ```
