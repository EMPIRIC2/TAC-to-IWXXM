...
class TestSmokeConversion:
    ...
    def test_manual_cor_input_converts_successfully(self, client):
        """Corrected METAR should pass manual-input validation and conversion."""
        response = client.post(
            "/api/v1/convert",
            data={
                "manual_text": "METAR COR FAOR 101200Z 12012KT 9999 FEW020 22/14 Q1018",
                "iwxxm_version": "2025-2",
                "validation_level": "comprehensive",
                "stop_on_error": "true",
            },
