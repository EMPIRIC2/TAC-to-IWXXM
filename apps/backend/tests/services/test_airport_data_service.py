...
class TestAirportDataRegeneration:
    ...
    def test_run_parser_success(self):
        ...
        with patch("src.services.airport_data.subprocess.run") as mock_run:
            ...
            mock_run.return_value = Mock(returncode=0, stdout="Loaded 1000 airports", stderr="")
    ...
    def test_run_parser_failure(self):
        ...
        with patch("src.services.airport_data.subprocess.run") as mock_run:
            ...
            mock_run.return_value = Mock(returncode=1, stdout="", stderr="Error parsing CSV")
    ...
    def test_run_parser_timeout(self):
        ...
        with patch("src.services.airport_data.subprocess.run") as mock_run:
            ...
            mock_run.side_effect = subprocess.TimeoutExpired(cmd="python parser.py", timeout=30)
