...
class TestCloudLayerValidationWithRealData:
    ...
    def test_cloud_layers_from_real_metars(self, rule, test_cases):
        ...
        # Report results
        print(f"\n\n{'='*70}")
        print(f"Cloud Layer Validation Results (Task 3.2)")
        print(f"{'='*70}")
    ...
    def test_altitude_ordering_statistics(self, rule, test_cases):
        ...
        # Report statistics
        print(f"\n\n{'='*70}")
        print(f"Cloud Layer Altitude Statistics (Task 3.2)")
        print(f"{'='*70}")
    ...
    def test_coverage_distribution(self, rule, test_cases):
        ...
        # Report statistics
        print(f"\n\n{'='*70}")
        print(f"Cloud Coverage Distribution (Task 3.2)")
        print(f"{'='*70}")
        print(f"Coverage type frequencies:")
