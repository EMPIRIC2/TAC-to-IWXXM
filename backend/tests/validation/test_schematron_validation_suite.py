...
class TestSchematronValidationSuite:
    ...
    def test_docker_validation_bgbw(self):
        ...
        assert 'Error' not in result.stderr or 'ERROR' not in result.stdout, \
            f"Validation error: {result.stderr}"
        ...
        try:
            ...
            print(f"  Assertions - Passed: {output.get('assertions_passed', 'N/A')}, Failed: {output.get('assertions_failed', 'N/A')}")
        except json.JSONDecodeError:
            print(f"✓ Validation completed (output not JSON)")
    ...
    def test_validation_wrapper_module(self):
        ...
        try:
            ...
            print(f"✓ Validation wrapper module imports successfully")
    ...
    def test_schematron_script_exists(self):
        ...
        print(f"✓ Schematron validator module exists at src/utilities/schematron_validator.py")
    ...
    def test_dockerfile_valid(self):
        ...
        print(f"✓ Dockerfile.schematron is valid at docker/Dockerfile.schematron")
