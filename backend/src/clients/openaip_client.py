...
class Airport:
    ...
    geometry: Optional[Dict[str, Any]] = None  # GeoJSON Point
...
class OpenAIPClient:
    ...
    def _parse_feature(self, feature: Dict[str, Any]) -> Optional[Airport]:
        ...
        if elevation:
            ...
            if elevation_unit.lower() in ["ft", "feet"]:
                elevation = float(elevation) * 0.3048  # feet to meters
            else:
