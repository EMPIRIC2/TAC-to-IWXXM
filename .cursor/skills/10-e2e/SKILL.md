...
Record in `{artifacts_dir}/reports/e2e-report.md``: separate columns for **T0**, **T2 connectivity**, **T3 browser**.
...
Write to `{artifacts_dir}/reports/e2e-report.md``.
