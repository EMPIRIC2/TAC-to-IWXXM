...
| **Active task** | T11.2 — Run full suite + TC-M001–M005 migration gate |
...
| T10.3 | Add weekly vendor sync GitHub Action | Config | completed | M6, User decision | T2.3 | — |
| T10.4 | Write TC-M004 no-submodule reference tests | Test | completed | test-plan.md TC-M004 | T10.1 | — |
