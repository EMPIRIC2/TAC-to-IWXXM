...
FEATURE_MAP: dict[str, str] = {
    ...
    "packages/auth": "F31, M4 — Supabase Auth JWKS + /auth/* (ADR-033)",
    ...
    "docs/adr/ADR-031": "F21/F22 — Public app + IndexedDB history (ADR-031)",
    "docs/adr/ADR-033": "F30/F31 — Platform independence Auth + DO Postgres + DOKS",
