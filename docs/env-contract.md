...
| Dissemination egress allowlist | `DISSEMINATION_EGRESS_ALLOWLIST` | API / `.env` (ADR-029); local live SQL e2e typically `127.0.0.1,localhost` + compose hosts — see tech-spec §Local mock BYOC |
