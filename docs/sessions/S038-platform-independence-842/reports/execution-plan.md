...
| T4.5 | Config | `/config.json`: `api.baseUrl` + Auth bootstrap; CORS origins for DOKS FE (placeholder OK) | config-spec | T4.2 | completed |
...
| T5.4 | Test | Post-migrate login session CRUD against DO; zero product Supabase DB traffic | TC-EV031-004; TC-F30-002 | T5.3 | completed |
