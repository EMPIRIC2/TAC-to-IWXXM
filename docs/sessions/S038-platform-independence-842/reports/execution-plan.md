...
| **Active task** | T0.4 — Placeholder DOKS DNS + 7d soak stub |
| **Tasks** | 3 / 38 completed |
...
| T0.4 | Docs | Placeholder DOKS hostnames in deploy/env; soak=7d checklist stub | `D-S038-04-b2` Q1/Q2 | T0.1 | in_progress |
