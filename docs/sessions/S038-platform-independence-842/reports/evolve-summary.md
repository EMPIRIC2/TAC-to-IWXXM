...
> Date: 2026-08-03  
> Status: **in progress** — M7 verify docs complete; **T6.5** soak-calendar blocked  
...
| Issue / Fn | Result |
|------------|--------|
| [#842](https://github.com/EMPIRIC2/TAC-to-IWXXM/issues/842) | Platform independence — DOKS provisional cutover under `D-S038-t63-waive` |
...
| **F30** | DO Postgres product DB; DOKS API/FE/worker; H4–H5 provisional PASS |
...
| M6 | DOKS IaC + cutover + soak | T6.1–T6.4 completed; **T6.5 pending** (7d soak) |
...
- **T6.5** — Render decommission after soak
