...
| Task | Type | Description | Spec Source | Depends On | Status |
|------|------|-------------|-------------|------------|--------|
| T3.1 | Test | Accept/negative fixtures **F27 theme T1** (UNNAMED, CB NIL, remarks NIL, `NO MSG EXP`, wind &lt;34 kt, no-longer-TC, …) | TC-F27-001/004; T1 | T2.4 | **pending** |
| T3.2 | Code | Registry rows + TCA rules for T1 | F27; ADR-028; F12 | T3.1 | **pending** |
...
| Task | Type | Description | Spec Source | Depends On | Status |
|------|------|-------------|-------------|------------|--------|
| T4.1 | Test | Golden `tc-advisory-A2-2`; M-xsd/M-sch; root `iwxxm:TropicalCycloneAdvisory` | TC-F27-002/003; T3 | T3.4 | **pending** |
