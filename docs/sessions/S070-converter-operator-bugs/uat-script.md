...
**Environment for Build:** local non-deployed preview first; staging after 13  
...
| UAT-003 | Operator | UJ-003 / 046 | Register, login, logout, reload | Session persist; guest convert still works | |
