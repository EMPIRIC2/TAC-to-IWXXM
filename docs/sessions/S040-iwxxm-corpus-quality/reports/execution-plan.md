...
| **Active task** | T2.7 — pending (next) |
| **Tasks** | 15 / 28 completed |
| **Last updated** | 2026-08-04 (T2.6 complete) |
...
**07-build** in progress — M2 F32 VONA; T2.1–T2.6 **done** → T2.7 backend `product=vona` + FE picker / Examples unlock.
