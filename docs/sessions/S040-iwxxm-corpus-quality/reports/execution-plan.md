...
| T1.3 | Test | Green equality + quality path lint→convert→XSD+SCH still green | TC-EV032-002/003 | T1.2 | **in_progress** |
...
| T2.5 | Code | Encode plugin in `annex3_products` (+ bulletin/AHL if discovered) | F6; E32-T3 | T2.4 | pending |
