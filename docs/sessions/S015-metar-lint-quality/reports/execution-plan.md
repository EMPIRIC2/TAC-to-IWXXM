...
| **Active task** | M5 / T5.5 — API smoke metar+speci+catalog (next) |
| **Tasks** | 28 / 35 completed (… T5.1–T5.4) |
...
| T3.12 | Code | Encode full R8 pack (HARD — no deferral) | E11-23; E11-28 | T3.11 | completed |
...
| T4.4 | Docs | Update COVERAGE_MATRIX METAR/SPECI rows; link research catalog | F15 acc3 | T4.3 | completed |
