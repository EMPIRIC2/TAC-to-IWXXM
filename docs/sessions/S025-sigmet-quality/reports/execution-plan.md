...
| T2.3 | Docs | Mark F23 themes G1–G3 closed or AskQuestion-deferred | S1.M1 | T2.2 | completed |
...
| T4.2 | Code | Convert fidelity for VA goldens | F6.d; #739 | T4.1 | completed |
...
| T5.6 | Test | 13-deploy-smoke — redeploy if API/FE changed; H1–H3 if API; **H4–H5 required** (T5.2) | 13; E19-7 | T5.5 | completed |
