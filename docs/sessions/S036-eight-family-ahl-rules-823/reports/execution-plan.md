...
| PR | [#827](https://github.com/EMPIRIC2/TAC-to-IWXXM/pull/827) **merged** — M1 AHL/COM/bulletin @ c338108 (2026-08-02T14:18:36Z); evolve branch continues for M2+; final evolve PR to `main` after Phase C/D |
