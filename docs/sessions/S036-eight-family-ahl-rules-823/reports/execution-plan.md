...
| T1.4 | Docs | Matrix/COM rows closed or child-issued | #823 B1 | T1.3 | **completed** |
...
| T2.2 | Code | Registry/encode/validate deltas for METAR gaps | F15; F6 | T2.1 | **completed** |
| T2.3 | Config | `metar-quality.yml` (or extend existing METAR pack) | E29-T4 | T2.2 | **completed** |
...
| T5.3 | Config | Extend `sigmet-quality.yml` for gen pack | E29-T4 | T5.2 | **completed** |
...
| T7.3 | Config | TC pack workflow (`tc-sigmet-quality.yml` or extend sigmet) | E29-T4 | T7.2 | **completed** |
| T7.4 | Docs | Close or child-issue #738 residuals | #738 | T7.3 | **completed** (#738 closed; residual #829) |
...
| T12.6 | Test | 13-deploy-smoke — API redeploy; H1–H3; **H4–H5 required** (FE Examples unlocked; TC-EV029-008) | E29-T6; 13 | T12.5 | pending |
