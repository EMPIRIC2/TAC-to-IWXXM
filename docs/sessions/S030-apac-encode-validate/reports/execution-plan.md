...
| T2.2 | Code | Align missing WX with Guidance | F6 | T2.1 | **completed** |

### M3 — P0 translationFailedTAC

| Task | Type | Description | Spec Source | Depends On | Status |
|------|------|-------------|-------------|------------|--------|
| T3.1 | Test | Official `*-translation-failed.xml` attr matrix | TC-EV023-003 | T2.2 | **completed** |
| T3.2 | Code | Quarantine emits original TAC | F6 | T3.1 | **completed** |
...
| T4.4 | Code | Convert + Form `emit_translation_centre` (+ optional fields) | E23-T2 | T4.3 | completed |
...
| T7.2 | Config | 08-verify-build | 08 | M0–M6 | in_progress |
