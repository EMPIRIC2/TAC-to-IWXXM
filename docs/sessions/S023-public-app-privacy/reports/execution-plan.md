...
| **Active task** | T2.1 — Unit tests: IDB CRUD, My METARs filter, soft-delete, export/import (TC-004) |
| **Tasks** | 4 / ~28 completed |
...
| Task | Type | Description | Spec Source | Depends On | Status |
|------|------|-------------|-------------|------------|--------|
| T2.1 | Test | Unit tests: IDB CRUD, My METARs filter, soft-delete, export/import round-trip (TC-004) | TC-004; UJ-004/018 | T1.2 | pending |
