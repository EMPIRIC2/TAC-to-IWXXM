...
|------|----------|------------------|---------|------|
| `AMD_PRESENT` | `info` | {product} AMD modifier present — research T1 | taf | modifier, taf, t1 |
...
| `INVALID_NIL` | `error` | {product} NIL must not include body groups — research R8 / T1 | — | nil, metar, speci, taf, r8, t1 |
