...
|-------|----------------|----------------|--------------------|--------|
| **G1** General SIGMET exceptional (CNL, point→circle, single alt, STNR, polygon/line CRS) | Registry + negatives | Guidance exceptional map | SCH | ⏳ Planned (TC-F23-002/004) |
| **G2** Sequence / validity / FIR·CTA / phenomenon / movement·intensity | Checklist rules | Observed/forecast + optional forecast positions | SCH | ⏳ Planned |
| **G3** General SIGMET golden convert + SCH | — | Expand annex3 (`sigmet-A6-1a-TS`, CNL, …) | M-xsd / M-sch / M-golden | ⏳ Planned (TC-F23-002) |
...
- [ ] F23 acc — SIGMET + VA SIGMET themes G1–G3 / V1–V3 / C1 closed or deferred (S025 / EV-019)
