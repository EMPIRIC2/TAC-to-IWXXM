...
| **METAR (CA)** | ✅ MANOBS + Annex 3 ([dig](../mining/manobs-manair-ca-mining-notes.md)) | ✅ IWXXM 3.0.0 + `iwxxm-ca` emitter (EV-064–067) | ⚠ WMO 3.0.0 XSD+SCH attempted · `iwxxm-ca` XSD **not executed** until EV-068 / #1035 · code-ca vocab ⚠ | EV-068 layered validate + golden XSD gate |
| **TAF (CA)** | ✅ MANAIR 8th Ed. ([dig](../mining/manobs-manair-ca-mining-notes.md)) | ✅ IWXXM 3.0.0 + `taf-ca` NCLWS emitter (EV-064 M4) | ⚠ WMO 3.0.0 attempted · `taf-ca.xsd` **not product-validated** until EV-068 | EV-068 `#1035` |
