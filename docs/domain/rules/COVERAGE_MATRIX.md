...
| **VAA** | ✅ Annex 3 App 2 §3.1.2 **shall** IWXXM + Table **A2-1** ([dig](../mining/icao-annex-3-mining-notes.md)); Doc 9766 paywall for colour **meanings**; colour machine IDs via registry ✅ | ✅ Guidance + examples + AviationColourCode + [METCE 1.2](https://schemas.wmo.int/metce/1.2/) `Volcano` | ✅ `volcanicAshAdvisory.xsd` (+ METCE embed) | **F26 / #736** S027/EV-021 — **V1–V3 closed** (T2.3); C1 pending T2.4; inventory [wmo-vaa-tca-examples-inventory.md](../../sessions/S027-vaa-quality/reports/wmo-vaa-tca-examples-inventory.md) |
...
| **C1** Common rules | ✅ where TAC | Shared with F23 C1 pattern | translation-failed not happy-path | Planned (T2.4) |
