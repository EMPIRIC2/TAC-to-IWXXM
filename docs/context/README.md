...
Session-scoped discovery. Design gates stay in the corpus rows cited inside each brief.
`docs/CORPUS.md` lists this directory as archival for design parity; new evolve briefs
still land here so they are not appended to `docs/context-brief.md`.
