...
|------|-------|--------|---------|-----------------|
| [verify-1177-1179](verify-1177-1179.md) | Staging auth UAT + export edges + research-token scan (#1177–#1179) | active | 2026-09-11 | F7, F15, F16, F31, TC-EV-beta-007/008 |
| [beta-ux-export-auth](beta-ux-export-auth.md) | Beta profiles/send + zip uniqueness + auth register (EV-beta-ux-export-auth) | closed (verify follow-up) | 2026-09-11 | F7, F10, F15, F16–F19, F31, F35, ADR-043 |
