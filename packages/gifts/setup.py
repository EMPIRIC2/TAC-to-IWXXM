...
try:
    ...
    site_package_dir = os.path.join(sys.prefix, "lib", "python{}.{}".format(sys.version_info.major, sys.version_info.minor), "site-packages")
    ...
    for d in os.listdir(site_package_dir):
        ...
        print("Unable to create bsp_files directory for skyfield module. Please create it manually with user & group write permissions")
