...
class Annex3(Common.Base):
    def __init__(self, version=None):
        ...
        neededCodes = [des.CLDAMTS, des.WEATHER, des.RECENTWX, des.CVCTNCLDS, des.SEACNDS, des.RWYDEPST, des.RWYCNTMS, des.RWYDEPST, des.RWYFRCTN]
        try:
        ...
        self.observedTokenList = ["temps", "altimeter", "wind", "vsby", "rvr", "pcp", "obv", "vcnty", "sky", "rewx", "ws", "seastate", "rwystate"]
        ...
        self._RunwayDepositDepths = {"92": "100", "93": "150", "94": "200", "95": "250", "96": "300", "97": "350", "98": "400"}
        ...
        for token in tokens:
            ...
            if friction.isdigit():
                ...
                if des.TITLES & des.RunwayFriction:
                    title = des.RunwayFrictionValues.get(friction, "Friction coefficient: %.2f" % (int(friction) * 0.01))
                    indent3.set("xlink:title", title)
