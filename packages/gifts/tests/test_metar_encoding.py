...
reqCodes = [des.WEATHER, des.SEACNDS, des.RWYFRCTN, des.RWYCNTMS, des.RWYDEPST, des.RECENTWX, des.CVCTNCLDS, des.CLDAMTS]
...
database = {"BIAR": "AKUREYRI|AEY|AKI|65.67 -18.07 27", "USRR": "SURGUT|SGC|SURGUT|61.33 73.42  44", "USTR": "TYUMEN/ROSCHINO|TJM||57.17 65.31  115"}
...
"""
    ...
    for element in ["surfaceWind", "visibility", "layer", "presentWeather", "airTemperature", "dewpointTemperature", "qnh"]:
