...
class TestEncoderEncode:
    ...
    def test_encode_with_decoder_error(self):
        ...
        self.encoder.decoder.return_value = {"err_msg": "Decoding failed", "bbb": "", "translationTime": "2024-01-20T12:00:00Z"}
        self.encoder.T1T2 = "L"
    ...
    def test_encode_with_geolocationsdb(self):
        ...
        decoded_tac = {"ident": {"str": "KJFK"}, "bbb": "", "translationTime": "2024-01-20T12:00:00Z"}
    ...
    def test_encode_with_receipt_time(self):
        ...
        with patch("gifts.common.xmlConfig.TRANSLATOR", True):
            ...
            result = self.encoder.encode("METAR KJFK 121851Z", receiptTime="2024-01-20T11:50:00Z")
    ...
    def test_encode_preserves_bbb_from_attrs(self):
        ...
        decoded_tac = {"ident": {"str": "KJFK"}, "bbb": "AAA", "translationTime": "2024-01-20T12:00:00Z"}
        self.encoder.decoder.return_value = decoded_tac
    ...
    def test_encode_with_additional_attributes(self):
        ...
        result = self.encoder.encode("METAR KJFK 121851Z", originating_center="KWBC", issue_time="2024-01-20T12:00:00Z")
    ...
    def test_encode_geolocationsdb_missing_ident_name(self):
        ...
        decoded_tac = {"ident": {"str": "KJFK"}, "bbb": ""}
        self.encoder.decoder.return_value = decoded_tac
