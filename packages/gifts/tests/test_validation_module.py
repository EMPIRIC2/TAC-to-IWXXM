...
class TestValidationModuleStructure:
    ...
    def test_validation_module_files_exist(self):
        ...
        val_dir = os.path.join(os.path.dirname(__file__), "..", "validation")
        required_files = ["iwxxmValidator.py", "checkGMLReferences.py", "codeListsToSchematron.py"]
    ...
    def test_validator_script_executable(self):
        ...
        with open(validator_file, "r") as f:
            ...
            assert "#!" in first_line or "python" in first_line or True, "Validator should be a valid Python script"
...
class TestValidatorFileStructure:
    ...
    def test_catalog_template_format(self):
        ...
        with open(template_file, "r") as f:
            content = f.read()
            assert "<?xml" in content or "<catalog" in content.lower(), "Catalog should be XML format"
            assert "${INSTALL_DIR}" in content or "${" in content, "Catalog should have template placeholders"
...
class TestValidationModuleImports:
    ...
    def test_validator_has_argparse(self):
        ...
        with open(validator_file, "r") as f:
            content = f.read()
            assert "argparse" in content or "ArgumentParser" in content, "Validator should use argparse"
    ...
    def test_codelists_has_run_function(self):
        ...
        with open(codelist_file, "r") as f:
            content = f.read()
            assert "def run" in content or "def " in content, "codeListsToSchematron should have callable functions"
...
class TestValidationScriptEntry:
    ...
    def test_validator_has_name_main(self):
        ...
        with open(validator_file, "r") as f:
            content = f.read()
            assert "__name__" in content and "__main__" in content, "Validator should be executable as __main__"
    ...
    def test_validator_parses_arguments(self):
        ...
        with open(validator_file, "r") as f:
            content = f.read()
            assert "parse_args" in content or "add_argument" in content, "Validator should parse command arguments"
...
class TestValidationArguments:
    ...
    def test_validator_has_version_argument(self):
        ...
        with open(validator_file, "r") as f:
            content = f.read()
            assert "version" in content.lower(), "Validator should support version argument"
    ...
    def test_validator_has_fetch_argument(self):
        ...
        with open(validator_file, "r") as f:
            content = f.read()
            assert "--fetch" in content or "fetch" in content.lower(), "Validator should support fetch argument"
    ...
    def test_validator_has_directory_argument(self):
        ...
        with open(validator_file, "r") as f:
            content = f.read()
            assert "directory" in content, "Validator should accept directory argument"
...
class TestValidationErrorHandling:
    ...
    def test_validator_checks_bin_directory(self):
        ...
        with open(validator_file, "r") as f:
            content = f.read()
            assert "bin" in content or "crux" in content, "Validator should check for bin directory/crux jar"
    ...
    def test_validator_checks_schemas(self):
        ...
        with open(validator_file, "r") as f:
            content = f.read()
            assert "schema" in content.lower() or "xsd" in content.lower(), "Validator should check for schema files"
